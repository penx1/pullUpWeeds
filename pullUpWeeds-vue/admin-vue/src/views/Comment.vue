...
<!--        <el-table-column prop="content" label="内容" sortable=""></el-table-column>-->
        ...
        <el-table-column prop="articleId" label="文章id" sortable=""></el-table-column>
      ...
      <div style="margin: 10px">
        ...
        <el-dialog title="修改评论" v-model="dialogVisible" width="60%">
  ...
  methods:{
    ...
    add(){
      ...
      this.$nextTick(()=>{  //对未来元素的操作
       if (!editor){
         editor = new E('#wangeditor1')//创建wangeditor对象
